def LecturerCode(batch):
    ...
    # for elec 3rd year
        ...
        lab_room=[['Electrical','Hydropower'],['Switchgear','Electrical'],['Switchgear','Electrical']]
        lab_room_lst = ['Computer', 'Electrical', 'Instrumentation', 'Drawing', 'Chemistry', 'Physics','Thermodynamics','Electronics','Workshop','Project', 'Hydropower', 'Switchgear', 'Class1', 'Class2']
    ...
    # for elec 4th year
        ...
        codeLst = [6,12,18,24]
        lecCodeLst = ['AJS','RUG','TN','DK','APS','PV','YB','RP','SDH','AB','TBM','Supervisor']
        lectId = [     38,   37,   35,  15,  39,   40,   7,  21,   41,  42,  43,    29]
        lab_lst = [27,30,33,36, 39, 42]
        lab_lecturer = [[39,40,7],[29], [21], [39,41,40,7], [37,42,35,43], [37,42,35,43]]
        lab_lec = [['APS','PV+YB'], ['Supervisor'],['RP'],['APS+SDH','PV+YB'],['RUG+AB','TN+TBM'],['RUG+AB','TN+TBM']]
...
def allLecturerCode():
    lec_name = ['BB', 'SP', 'ML', 'DMG', 'SLS', 'JJ', 'YB', 'AS','BK','SKS', 'DG', 'RS', 'PPB', 'SKR','DK','RG', 'PL', 'SS','PG','PS','RP','AK','CD','MLP','BRM','RPD','NRB', 'TEST', 'Supervisor','RN', 'KB','RP', 'SN', 'NK', 'TN', 'GT', 'RUG', 'AJS', 'APS', 'PV', 'SDH', 'AB', 'TBM', 'GCJ', 'SD', 'AD', 'NS','SL', 'IMS']
