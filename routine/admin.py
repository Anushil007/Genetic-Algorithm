...
admin.site.register(Computer_First)
admin.site.register(Computer_Second)
admin.site.register(Computer_Third)
admin.site.register(Computer_Fourth)
admin.site.register(Electrical_First)
